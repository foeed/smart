...
products = [
    ...
    },
    {
        ...
        'brand': 'Apple',
        'category': 'Electronics',
        'type': 'Smartphone',  # Add 'type' field
        'price': 599.99,
        'countInStock': 0,
        'rating': 4.0,
        'numReviews': 8,
    ...
    },
    {
        ...
        'brand': 'Sony',
        'category': 'Electronics',
        'type': 'Gaming Console',  # Add 'type' field
        'price': 399.99,
        'countInStock': 11,
        'rating': 5,
        'numReviews': 12,
    },
    {
        ...
        'brand': 'Logitech',
        'category': 'Electronics',
        'type': 'Gaming Accessories',  # Add 'type' field
        'price': 49.99,
        'countInStock': 7,
        'rating': 3.5,
        'numReviews': 10,
    },
    {
        ...
        'brand': 'Amazon',
        'category': 'Electronics',
        'type': 'Smart Speaker',  # Add 'type' field
        'price': 29.99,
        'countInStock': 0,
        'rating': 4,
        'numReviews': 12,
